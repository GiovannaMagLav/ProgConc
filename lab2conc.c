...
int *vet; //vetor que sera manipulado no programa
...
//funçao executada pelas threads
...
//aloca espaco e inicializa o vetor de inteiros
...
int main(int argc, char *argv[]) {
   ...
   //aloca espaco e inicializa o vetor de entrada
   ...
   GET_TIME(start); //comeca a contagem de tempo
   //dispara as threads
